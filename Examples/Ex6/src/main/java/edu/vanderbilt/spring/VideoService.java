...
public class VideoService {
	...
	public Video addVideoWithFields(@RequestBody String name, @RequestBody int size, @RequestBody String genre,
	...
	public void updateVideo(@PathVariable("id") Long id, @RequestBody String name, @RequestBody int size, @RequestBody String genre,
			@RequestBody String URL){
		Video video = videos_.findOne(id);
		video.setName(name);
		video.setSize(size);
		video.setGenre(genre);
		video.setURL(URL);
