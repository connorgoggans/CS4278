...
public class DormitoryResource {
    ...
    @Timed
    public ResponseEntity<Dormitory> createDormitory(@Valid @RequestBody Dormitory dormitory) throws URISyntaxException {
    ...
    @RequestMapping(value = "/dormitories",
        ...
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<Dormitory> updateDormitory(@Valid @RequestBody Dormitory dormitory) throws URISyntaxException {
