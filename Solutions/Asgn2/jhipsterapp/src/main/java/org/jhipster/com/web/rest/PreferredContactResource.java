...
import org.jhipster.com.repository.PreferredContactRepository;
...
public class PreferredContactResource {
    ...
    @Timed
    public ResponseEntity<PreferredContact> createPreferredContact(@Valid @RequestBody PreferredContact preferredContact) throws URISyntaxException {
    ...
    @RequestMapping(value = "/preferred-contacts",
        ...
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<PreferredContact> updatePreferredContact(@Valid @RequestBody PreferredContact preferredContact) throws URISyntaxException {
