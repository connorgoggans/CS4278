...
public class PreferredContactResourceIntTest {
    ...
    public void checkNameOfChoiceIsRequired() throws Exception {
        int databaseSizeBeforeTest = preferredContactRepository.findAll().size();
        // set the field null
        preferredContact.setNameOfChoice(null);

        // Create the PreferredContact, which fails.
        ...
        List<PreferredContact> preferredContacts = preferredContactRepository.findAll();
        assertThat(preferredContacts).hasSize(databaseSizeBeforeTest);
    }
