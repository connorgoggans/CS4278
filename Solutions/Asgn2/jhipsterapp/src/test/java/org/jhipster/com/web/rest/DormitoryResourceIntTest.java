...
import org.jhipster.com.repository.DormitoryRepository;
...
public class DormitoryResourceIntTest {
    ...
    @Test
    @Transactional
    public void checkDormNameIsRequired() throws Exception {
        int databaseSizeBeforeTest = dormitoryRepository.findAll().size();
        // set the field null
        dormitory.setDormName(null);

        // Create the Dormitory, which fails.
        ...
        List<Dormitory> dormitories = dormitoryRepository.findAll();
        assertThat(dormitories).hasSize(databaseSizeBeforeTest);
    }
